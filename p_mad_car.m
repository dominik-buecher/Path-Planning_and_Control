...
P_p_s10 = 0.67;  % s1 position [ m ] Carid 0
P_p_s20 = 0.15;  % s2 position [ m ] Carid 0
% P_p_s10 = 0.2;  % s1 position [ m ] Carid 0
% P_p_s20 = 0.4;  % s2 position [ m ] Carid 0
...
P_p_own = [P_p_s10; P_p_s20; 0; 0; 0; 0; 0 ];
...
CarInputsCmdHalt = uint8(0);        % Aufgabe 5.2
CarInputsCmdForward = uint8(1);     % Aufgabe 5.2
CarInputsCmdReverse = uint8(2);     % Aufgabe 5.2
CarInputsCmdSlow = uint8(3);        % Aufgabe 5.2
